const websiteText = () => ({
  ...
  frontPage_2: `I moved to Stockholm, Sweden in April 2019 to pursue a new career in web development. After completing a coding bootcamp at {saltLink}
  ...
  advisory:
    'These projects may take {timeToLoad}, if an app is unused for a period of time Heroku unloads it, freeing up space on their servers',
});
